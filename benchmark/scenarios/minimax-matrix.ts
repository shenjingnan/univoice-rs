...
import {
  ...
  minimaxScenarioConfig as matrixScenarioConfig,
  minimaxMatrixItems,
  runProviderMatrixScenario,
} from './matrix';

// 重新导出数据
export { matrixScenarioConfig, minimaxMatrixItems };
...
export async function runMinimaxMatrixScenario(options?: {
  ...
  return runProviderMatrixScenario(MINIMAX_MATRIX_CONFIG, {
    ...options,
    provider: 'minimax',
  });
}
