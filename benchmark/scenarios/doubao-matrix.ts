...
import {
  ...
  doubaoMatrixItems,
  doubaoScenarioConfig as matrixScenarioConfig,
  runProviderMatrixScenario,
} from './matrix';

// 重新导出数据
export { doubaoMatrixItems, matrixScenarioConfig };
...
export async function runDoubaoMatrixScenario(options?: {
  ...
  return runProviderMatrixScenario(DOUBAO_MATRIX_CONFIG, {
    ...options,
    provider: 'doubao',
  });
}
