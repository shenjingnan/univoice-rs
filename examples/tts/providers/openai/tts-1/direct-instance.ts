/**
 * OpenAI TTS tts-1 - 直接实例化示例
 * 演示不使用工厂函数 createTTS，直接 new OpenAITTS() 创建实例
 *
 * 特点:
 ...
 *
 * 使用方法:
 * npx tsx examples/tts/providers/openai/tts-1/direct-instance.ts
 */
