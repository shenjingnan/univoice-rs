 ...
 *
 * 使用方法:
 * npx tsx examples/tts/providers/qwen/qwen3-tts-instruct-flash-realtime/direct-instance.ts
 */
...
async function main() {
  ...
  // instruct 模型支持 instructions 参数，可控制语音情感和语气
  ...
  console.log(`\n[${timestamp()}] === Qwen3 TTS Instruct Flash Realtime - 直接实例化 ===`);
