/**
 * Paraformer Realtime v2 - 直接实例化示例（Opus 数据包）
 ...
 *
 * 使用方法:
 * npx tsx examples/asr/providers/qwen/paraformer-realtime-v2/direct-instance.ts
 */
...
async function main() {
  ...
  console.log(
    `\n[${timestamp()}] === Paraformer Realtime v2 - 直接实例化 / 流式入/流式出（Opus 数据包）===`
  );
