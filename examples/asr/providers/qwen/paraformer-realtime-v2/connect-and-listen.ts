/**
 * Paraformer Realtime v2 - 连接预建立示例（Opus 数据包）
 ...
 *
 * 使用方法:
 * npx tsx examples/asr/providers/qwen/paraformer-realtime-v2/connect-and-listen.ts
 */
...
async function main() {
  ...
  console.log(`\n[${timestamp()}] === Paraformer Realtime v2 - 连接预建立 ===`);
